...
_availablePositions = [
	[12640.4,16412.8,0.00143814],
	[6210.22,16226.5,0.00143433],
	[20893.7,19228.1,0.00143909],
	[13504,12037.7,0.00153828],
	[18315.2,15527.2,0.00149918],
	[15987.6,16246.5,0.00141335],
	[15360.8,16014.7,0.00146055]
];
...
switch(playerside) do {
	...
	case west:{_sideString = "Blufor"};
	case resistance:{_sideString = "Opfor"};
	case independent:{_sideString = "Independent"};
	default {_sideString = ""};
};

_SITREP = [
	["Olympus Entertainment CQC", ""],
	["", "<br/>"],
	[format["%1 - %2",toUpper _txt,toUpper _sideString], ""],
	["", "<br/>"],
	["", "<br/>"],
	["", "<br/>"],
	["", "<br/>"]
