...
class CQC_RscControlsGroup {
	...
	class VScrollBar : CQC_RscScrollBar
	{
		width = 0.021;
		autoScrollEnabled = 1;
	};
	
	class HScrollBar : CQC_RscScrollBar
	{
		height = 0.028;
	};
...
class CQC_RscListNBox
{
	...
	idcLeft = -1;
	idcRight = -1;
	class ListScrollBar: CQC_RscScrollBar{};
	class ScrollBar: CQC_RscScrollBar{};
};
...
class CQC_RscTextMulti : CQC_RscText
{
	fade = 1;
	linespacing = 1;
	style = 0 + 16 + 0x200;
...
class CQC_RscShortcutButtonMain : CQC_RscShortcutButton {
	fade = 1;
	idc = -1;
	style = 0;
	default = 0;
...
class CQC_RscBackground : CQC_RscText {
	type = 0;
	fade = 1;
	IDC = -1;
	style = 512;
...
class CQC_RscCombo {
	...
	class ComboScrollBar : CQC_RscScrollBar {};
};
...
class CQC_RscPictureButton {
		class TabBackground: CQC_RscText{
			idc = -1;
		...
		class TabPicture: CQC_RscPicture{
			idc = -1;
